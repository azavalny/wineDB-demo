...
-- Insert wines
INSERT INTO wine (vineyard_id, name, classification, grape, year, price)
VALUES
(1, 'Vulkà Bianco', 'DOC', 'Carricante', 2021, 22),
(2, 'Reserve Late Harvest', 'Special Reserve', 'Riesling', 2020, 18),
(3, 'Wild Child Block', 'Estate', 'Pinot Noir', 2022, 24),
(4, 'Ars In Vitro', 'Vino de Autor', 'Tempranillo', 2019, 30),
(5, 'Belsito', 'DOCG', 'Frappato', 2021, 19),
(6, 'Les Natures', 'Organic', 'Pinot Blanc', 2020, 28),
(7, 'Mountain Cuvée', 'Proprietary Blend', 'Cabernet Sauvignon', 2021, 25),
(8, 'Rosso', 'IGT', 'Nero dAvola', 2020, 17),
(9, 'Felix', 'Reserva', 'Malbec', 2021, 20),
(10, 'Winemaker Selection', 'Estate', 'Malbec', 2020, 22),
(11, 'Valdelayegua Crianza', 'Crianza', 'Tempranillo', 2018, 27),
(12, 'Vin de Maison', 'Table Wine', 'Cabernet Franc', 2022, 16),
(13, 'Ficiligno', 'DOC', 'Grillo', 2020, 21),
(14, 'Signature Selection', 'Reserve', 'Zinfandel', 2021, 29),
(15, 'Aynat', 'DOC', 'Inzolia', 2021, 19),
(16, 'King Ridge Vineyard', 'Estate', 'Chardonnay', 2022, 34),
(17, 'Dalila', 'Blend', 'Grillo', 2020, 22),
(18, 'Mascaria Barricato', 'Barricato', 'Nero dAvola', 2021, 24),
(19, 'Nouveau', 'AOC', 'Gamay', 2022, 14),
(20, 'Hyland', 'Single Vineyard', 'Pinot Gris', 2021, 20),
(21, 'Nouveau', 'AOC', 'Gamay', 2022, 15),
(22, 'Eté Indien', 'Cru', 'Gamay', 2021, 18),
(23, 'La Fleur Amélie', 'AOC', 'Sauvignon Blanc', 2021, 23),
(24, 'Estate', 'Proprietary', 'Cabernet Sauvignon', 2021, 35),
(25, 'Prugneto', 'DOC', 'Sangiovese', 2020, 21),
(26, 'Alder Ridge Vineyard', 'Single Vineyard', 'Syrah', 2021, 26),
(27, 'Brut Rosé', 'Champagne', 'Pinot Meunier', 2019, 40),
(28, 'Golden Horn', 'Reserve', 'Syrah', 2020, 25),
(29, 'Inspired', 'Estate', 'Cabernet Franc', 2021, 24),
(30, 'Brut Rosé', 'Champagne', 'Chardonnay', 2020, 42),
(31, 'Old Vine', 'Old Vine', 'Zinfandel', 2019, 30);
